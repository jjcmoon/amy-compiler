(module 
  ...
  (func $Hello_odd (param i32) (result i32) (local i32)
    get_local 0
    i32.const 0
    i32.eq
    if (result i32)
  ...
  (func $Hello_even (param i32) (result i32) (local i32)
    get_local 0
    i32.const 0
    i32.eq
    if (result i32)
  ...
  (func $Hello_main (local i32)
    ...
    loop $tramp (result i32)
      ...
      if (result i32)
        ...
        get_global 0
        i32.load
        call_indirect $return_iti
        set_local 0
        br $tramp
      end
    end
    call $Std_printBoolean
    drop
  )
)